  ...
  return (
    <section className="w-full py-20">
      <div className="max-w-[1440px] mx-auto">
        <div className="bg-[#06153A] rounded-[40px] p-16 relative">
          {/* Top Section */}
          <div className="mb-24">
            <div className="flex items-center gap-4 mb-8">
              <div className="w-4 h-4 rounded-full bg-[#E7DED7]"></div>
              <h2 className="text-white text-[64px] font-normal">
                BELIEVE IN ALLINA
              </h2>
            </div>
            
            <p className="text-white text-lg leading-7 max-w-[600px]">
          ...
          {/* Form Section */}
          <div className="w-[528px] ml-auto">
            {/* Button Group */}
            <div className="flex mb-16 border-2 border-[#E7DED7] rounded-md overflow-hidden">
              <button className="flex-1 bg-[#06153A] text-white py-4 px-8 text-lg">
                Register with Us
              </button>
              <button className="flex-1 bg-[#E7DED7] text-[#06153A] py-4 px-8 text-lg">
                LOREM
              </button>
            </div>
            ...
            <form className="space-y-12">
              <div>
                <input
                  type="text"
                  placeholder="NAME"
                  className="w-full bg-transparent border-b-2 border-[#E7DED7] text-white py-2 placeholder-[#E7DED7] focus:outline-none focus:border-white transition-colors text-lg uppercase tracking-wider"
                />
              </div>
              <div>
                <input
